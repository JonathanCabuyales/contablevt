...
@Component({
  selector: 'app-dialoglame',
  templateUrl: './dialoglame.component.html',
  styleUrls: ['./dialoglame.component.css']
})
export class DialoglameComponent implements OnInit {
  ...
  descIva: string = '';
  fechaFacturaAutorizacionEgreso: string = '';
  ...
  enviarEgresos(){
    let enviar = {
      ...
      fecha_autorizacion: this.fechaFacturaAutorizacionEgreso
    }
...
insertarEgresosLame(data: any){
  ...
  .subscribe((resp) =>{
    ...
    this.ivavalorEgreso = '';
    this.totalEgreso = '';
    this.fechaFacturaAutorizacionEgreso = '';
  });
}

cambioFechaAutorizacion(evento : any){
  this.fechaFacturaAutorizacionEgreso = evento;
}
